...
final class IntegrationServicesTests: XCTestCase {
    ...
    func testCodexCLIConfigurationDoesNotChangeBaseConfiguration() throws {
        ...
        XCTAssertTrue(profile.contains("base_url = \"http://127.0.0.1:49152/v1\""))
        XCTAssertTrue(profile.contains("model_provider = \"nativ\""))
        XCTAssertTrue(profile.contains(basicModel.id))
