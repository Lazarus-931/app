...
struct NativSettings: Codable, Equatable {
    ...
    var browsing: BrowsingConfiguration
    ...
    init(
        ...
        self.skills = skills
        self.browsing = browsing.normalized()
    ...
    init(from decoder: Decoder) throws {
        ...
        browsing = try container.decodeIfPresent(BrowsingConfiguration.self, forKey: .browsing) ?? defaults.browsing
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(browsing.normalized(), forKey: .browsing)
    ...
    func normalized() -> Self {
        ...
        settings.browsing = settings.browsing.normalized()
